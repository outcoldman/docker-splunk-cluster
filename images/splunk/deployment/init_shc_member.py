...
def substitution():
    return {
        ...
        "@SHCLUSTERING_MGMT_URI@": os.environ.get("INIT_SHCLUSTERING_MGMT_URI", "https://%s:8089" % os.environ.get("INIT_SHCLUSTERING_HOSTNAME", socket.getfqdn())),
...
def verify_membership(consul_session_id):
    ...
    for x in xrange(1, 1800):
        ...
        if locked:
            response = init_consul.consul_put("/kv/" + key_member, data=("https://%s:8089" % os.environ.get("INIT_SHCLUSTERING_HOSTNAME", socket.getfqdn())))
